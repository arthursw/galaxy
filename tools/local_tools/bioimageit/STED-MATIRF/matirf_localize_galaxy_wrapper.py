#!/usr/bin/env python3
"""Galaxy wrapper for PyFlow Tool matirf_localize"""
...
from matirf_localize import Tool

# Create argument parser
parser = argparse.ArgumentParser(
    prog='matirf_localize',
...
parser.add_argument('--mode', help='Mode (0:batch, 1:visu)')
parser.add_argument('--object_size_nm', help='Objects size in nm')
