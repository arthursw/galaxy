...
parser.add_argument('--keep_labels_unchanged', action='store_true', help='By default, bright spots are removed (labels 1 are set to 0) and exocytose events (labels 2) are set to 1. This option skip this step, so labels are kept unchanged.')
